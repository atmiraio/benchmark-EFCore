...
namespace EFCore5
{
    ...
    {
        public EFCore5DbContext(DbContextOptions<EFCore5DbContext> options) : base(options) { }
        ...
        //    optionsBuilder.UseSqlServer(@"Server=.\SQLEXPRESS;Database=EFCore5;Trusted_Connection=True;");
